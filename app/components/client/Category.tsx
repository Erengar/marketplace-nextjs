...
export default function Category(props: {category: CategoryType}) {
    ...
    return (
        <Link href={`${props.category.name.toLowerCase()}`}>
            ...
            text-sky-900 bg-yellow-400 hover:bg-slate-400 hover:scale-110 active:outline-1 active:outline-neutral-400 active:scale-110
            font-semibold border border-solid rounded-lg min-w-fit min-h-fit max-w-sm max-h-sm h-40 w-40 flex justify-center items-center"
