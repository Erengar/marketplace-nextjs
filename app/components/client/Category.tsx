...
export default function Category({category}: {category: CategoryType}) {
    ...
    const startHover = () => {
        ...
        setTimeout(() => {document.getElementById("category-description")?.classList.add('z-20')}, 500)
    }
    const endHover = () => {
    ...
    return (
        ...
        onMouseLeave={endHover}>
            ...
            font-semibold border border-solid rounded-lg min-w-fit min-h-fit max-w-sm max-h-sm h-40 w-40 flex justify-center items-center z-10 hover:z-30`}
            key={category.name}
