...
export default function ConfirmationModal({needConfirm, deleteItem, item, table}: ConfirmationModalProps) {
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-base font-bold text-sky-950 antialiased">{`Are you sure you want to remove ${item.name} from ${table} table?`}</h2>
